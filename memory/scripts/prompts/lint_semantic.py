...
_TEMPLATE = """Review this knowledge base for contradictions, inconsistencies, or
...
def build(wiki_content: str) -> str:
    return _TEMPLATE.format(wiki_content=wiki_content)
