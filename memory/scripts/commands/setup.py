"""Entrypoint for the `automaton:wiki setup` skill.
...
Toggle hooks later:
  ...
  automaton:wiki hooks disable
  automaton:wiki hooks status

Hooks are registered by the automaton plugin. Make sure the plugin is
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    be set.
    """
    parser = argparse.ArgumentParser(prog="setup", description="automaton:wiki setup entrypoint")
