...
6. **Write design doc** — save to `docs/development/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/development/specs/YYYY-MM-DD-<topic>-design.md`
